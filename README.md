...
Este proyecto surge como una iniciativa de proyecto para la asignatura de **Ingeniería de Software **. El objetivo principal es modernizar y centralizar la gestión administrativa de la Parroquia San Pedro Nolasco, optimizando la coordinación de sus voluntarios y el uso de sus instalaciones.
...
### Objetivo General
Identificar las deficiencias en el proceso de asignación de tareas de la Parroquia San Pedro Nolasco y proponer una solución tecnológica integral utilizando metodologías de **Design Thinking**.
